...
/**
 * Cuerpo del Frasario: frases memorables agrupadas por autor. Cualquier miembro
 * puede añadir frases y editar las de los demás. El host aporta el <Screen>.
 */
export function PhrasebookContent() {
  const { t } = useLanguage();
